...
class ItemViewModelFactory(private val getItemsUseCases: GetItemsUseCases,
    private  val updateItemsUseCases: UpdateItemsUseCases ,private val searchItemUseCases: SearchItemUseCases):ViewModelProvider.Factory{

    override fun <T : ViewModel> create(modelClass: Class<T>): T {

        return ItemViewModel(getItemsUseCases,updateItemsUseCases,searchItemUseCases)as T
    }
